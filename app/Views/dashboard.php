            ...
            <div class="page-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-size-16 mt-2">Today Sales</div>
                                    </div>
                                </div>
                                <h4 class="mt-4"><?=  $today_sales['total']; ?></h4>
                                <div class="row">
                                    <div class="col-7">
                                        <p class="mb-0">
                                            <?php if($today_sales['increments'] > 0){ ?>
                                                <span class="text-success me-2"> <?=  $today_sales['increments']; ?>% <i class="mdi mdi-arrow-up"></i> </span>
                                            <?php }else{ ?>
                                                <span class="text-danger me-2"> <?=  $today_sales['increments']; ?>% <i class="mdi mdi-arrow-down"></i> </span>
                                            <?php } ?>
                                        </p>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-size-16 mt-2">Total Partners</div>

                                    </div>
                                </div>
                                <h4 class="mt-4"><?=  $total_partners; ?></h4>
                                <div class="row">
                                    <div class="col-7">
                        ...
                        <div class="card bg-primary">
                            <div class="card-body">
                                <div class="text-white-50">
                                    <h5 class="text-white">2400 + Total Users</h5>
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-8">
                                        <div class="mt-4">
                                            <img src="assets/images/widget-img.png" alt="widget-img" class="img-fluid mx-auto d-block">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Partners</h4>
                                ...
                                <ul class="inbox-wid list-unstyled">
                                    ...
                                    <li class="inbox-list-item">
                                        <a href="javascript: void(0);">
                                            <div class="d-flex align-items-start">
                                                <div class="me-3 align-self-center rounded-circle avatar-sm text-white text-center" style="background-color:#<?=  $partner['avatars'];?>;">
                                                  <p class="mt-2"><strong><?=  strtoupper($partner['initial']); ?></strong></p>
                                                </div>
                                                <div class="flex-1 overflow-hidden">
                                                    <h5 class="font-size-16 mb-1"><?=  strtoupper($partner['name']); ?></h5>
                                                    <p class="text-truncate mb-0"><?=  $partner['contact_no']; ?></p>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                ...
                                <div class="text-center">
                                    <a href="<?=  base_url('partner'); ?>" class="btn btn-primary">Load More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="reviewExampleControls" class="carousel slide review-carousel" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div>
                                                <p>To achieve this, it would be necessary to have achieveuniform grammar,
                                        ...
                                        <div class="carousel-item">
                                            <div>
                                                <p>For science, music, sport, pronunciation etc, Europe uses the same vocabulary
                                                    languages only differ in their grammar</p>
                                                <div class="d-flex align-items-start mt-4">
                                                    <div class="avatar-sm me-3">
                                                        <img src="assets/images/users/avatar-4.jpg" alt="avatar-4" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div class="flex-1">
                                        ...
                                        <div class="carousel-item">
                                            <div>
                                                <p>The new common language will be more simple language and regular than the
...
<script>
    ...
    series: [
        {
            name: "<?=  $sales_report['last_year']['year']; ?>",
            type: 'line',
            data: [
                <?=  $sales_report['last_year']['dataset'][0]; ?>,
                <?=  $sales_report['last_year']['dataset'][1]; ?>,
                <?=  $sales_report['last_year']['dataset'][2]; ?>,
                <?=  $sales_report['last_year']['dataset'][3]; ?>,
                <?=  $sales_report['last_year']['dataset'][4]; ?>,
                <?=  $sales_report['last_year']['dataset'][5]; ?>,
                <?=  $sales_report['last_year']['dataset'][6]; ?>,
            ],
        },
        {
            name: "<?=  $sales_report['current_year']['year']; ?>",
            data: [
                <?=  $sales_report['current_year']['dataset'][0]; ?>,
                <?=  $sales_report['current_year']['dataset'][1]; ?>,
                <?=  $sales_report['current_year']['dataset'][2]; ?>,
                <?=  $sales_report['current_year']['dataset'][3]; ?>,
                <?=  $sales_report['current_year']['dataset'][4]; ?>,
                <?=  $sales_report['current_year']['dataset'][5]; ?>,
                <?=  $sales_report['current_year']['dataset'][6]; ?>,
            ],
            type: 'area',
        }
    ],
    ...
    xaxis: {
        categories: [
            "<?=  $sales_report['label'][0]; ?>", 
            "<?=  $sales_report['label'][1]; ?>", 
            "<?=  $sales_report['label'][2]; ?>", 
            "<?=  $sales_report['label'][3]; ?>", 
            "<?=  $sales_report['label'][4]; ?>", 
            "<?=  $sales_report['label'][5]; ?>", 
            "<?=  $sales_report['label'][6]; ?>", 
