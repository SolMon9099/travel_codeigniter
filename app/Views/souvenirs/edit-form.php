                    ...
                    <div class="col-lg-12">
                        <div class="souvenird">
                            <div class="souvenird-body">
                                <h4 class="souvenird-title mb-4"><?= lang('Update Souvenir') ?></h4>
                                                ...
                                                <div class="col col-md-offset-2">
                                                    <div class="row d-flex justify-content-center">
                                                        <div class="row d-flex justify-content-center mb-2">
                                                            <a href="<?= base_url("delete_souvenir_photo/$data[souvenir_id]") ?>" onclick="return confirm('Delete this souvenir image?');" class="btn btn-danger btn-sm w-auto"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                        <div class="row d-flex justify-content-center">
                                                            <img src="<?= base_url('uploads/souvenirs/'.$data['photo']) ?>" style="width: auto; max-height: 300px;">
                                                        </div>
                                    ...
                                    <form action="<?= base_url('save_update_souvenir/'.$data['souvenir_id']) ?>" method="post" enctype='multipart/form-data'>
                                        <div class="row">
