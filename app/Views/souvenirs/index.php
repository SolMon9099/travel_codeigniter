                            ...
                            <div class="souvenird-body">
                                <div class="invoice-title mb-4">
                                    <div class="float-end font-size-16">
                                        <a href="/souvenir_add" class="btn font-16 btn-primary" id="">
                                            <i class="mdi mdi-plus-circle-outline"></i> 
                                            <?= lang('Add New Souvenir') ?>
                                        </a>
                                    </div>
                                    ...
                                    <table id="datatable" class="table table-nowrap table-centered mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center"><?= lang('Souvenir Name') ?></th>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?= base_url('update_souvenir/'.$data['souvenir_id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                            <a href="<?= base_url('delete_souvenir/'.$data['souvenir_id']) ?>" class="btn btn-danger" onclick="return confirm('Delete this souvenir from the system ?');"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                        <td class="text-center">
                                                        ...
                                                        <td class="text-center col-2">
                                                            <?php
                                                                if ($data['photo'] != "") {
                                                            ?>
                                                                    <img src="<?= base_url('uploads/souvenirs/'.$data['photo']) ?>" class="w-100">
                                                            <?php
                                                                } else {
                                                                    echo "n/a";
                                                                }
