                            ...
                            <div class="packaged-body">
                                <div class="invoice-title mb-4">
                                    <div class="float-end font-size-16">
                                        <a href="/package_add" class="btn font-16 btn-primary" id="">
                                            <i class="mdi mdi-plus-circle-outline"></i> 
                                            <?= lang('Add New Package') ?>
                                        </a>
                                    </div>
                                    <h4 class="packaged-title mb-4"><?= $title ?></h4>
                                </div>
                                <br>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?= base_url('update_package/'.$data['package_id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                            <a href="<?= base_url('delete_package/'.$data['package_id']) ?>" class="btn btn-danger" onclick="return confirm('Delete this package from the system ?');"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                        <td class="text-center">
                                                        ...
                                                        <td class="text-center col-2">
                                                            <?php
                                                                if ($data['photo'] != "") {
                                                            ?>
                                                                    <img src="<?= base_url('uploads/packages/'.$data['photo']) ?>" class="w-100">
                                                            <?php
                                                                } else {
                                                                    echo "n/a";
                                                                }
