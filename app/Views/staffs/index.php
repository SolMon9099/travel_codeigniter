                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?= base_url('update_staff/'.$data['staff_id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                            <a href="<?= base_url('delete_staff/'.$data['staff_id']) ?>" class="btn btn-danger" onclick="return confirm('Delete this staff from the system ?');"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                        <td>
