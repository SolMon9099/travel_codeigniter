                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('save_update_staff/'.$staff['staff_id']);?>" method="POST">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label"><?= lang('Username (optional)') ?></label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label"><?= lang('Password (optional)') ?></label>
