                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="invoice-title mb-4">
                                    <div class="float-end">
                                        <a type="button" onclick="history.back();" *href="<?= base_url('product') ?>" class="btn btn-secondary">
                                            Back
                                        </a>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-2"><b>Century Price</b></div>
                                    <div class="col-md-4">:&ensp;<?= "RM ".$product['century_price'] ?></div>
                                    <div class="col-md-2"><b>Century Warranty</b></div>
                                    <div class="col-md-4">:&ensp;<?= $product['century_warranty_month']." Month(s)" ?></div>
                                </div>
