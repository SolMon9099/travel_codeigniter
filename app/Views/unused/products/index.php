                                        ...
                                        <thead>
                                            <tr>
                                              ...
                                              <th rowspan="2" class="text-center"><?= lang('Photo') ?></th>
                                                ...
                                                <th colspan="3" class="text-center"><?= lang('Selling Price (RM)') ?></th>
                                                <th colspan="3" class="text-center"><?= lang('Warranty Month') ?></th>
                                            </tr>
                                            <tr>
                                                <th class="text-center"><?= lang('Normal') ?></th>
                                                <th class="text-center"><?= lang('Workshop') ?></th>
                                                <th class="text-center"><?= lang('Century') ?></th>
                                                <th class="text-center"><?= lang('Normal') ?></th>
                                                <th class="text-center"><?= lang('Workshop') ?></th>
                                                <th class="text-center"><?= lang('Century') ?></th>
                                            </tr>
