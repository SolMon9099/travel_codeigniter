                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('save_update_product/'.$product['id']);?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><?= lang('Century Selling Price (RM)') ?></label>
                                            <input class="form-control" type="text" name="century_price" placeholder="0.00" onkeypress="return isNumber(event, 1);" value="<?= $product['century_price']; ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><?= lang('Century Warranty Month') ?></label>
                                            <input class="form-control" type="text" name="century_warranty_month" placeholder="0" onkeypress="return isNumber(event, 0);" value="<?= $product['century_warranty_month']; ?>">
                                        </div>
                                    </div>
