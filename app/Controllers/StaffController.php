...
class StaffController extends BaseController
{
	...
	public function index()
	{
		$data = [
			...
			'staffs' => $this->staffModel->orderBy("staff_id", "DESC")->findAll(),
		];
	...
	public function update_form($staff_id = null)
	{
		$data = [
	...
	public function save_update($staff_id = null)
	{
		$data = [
		    'username' => $_POST['username'] ?? "",
		    'password' => $_POST['password'] ?? "",
		...
		$this->staffModel->update($staff_id, $data);

		return redirect('staff')->with('status', 'Staff updated Successfully');
	}

	public function delete_staff($staff_id = null)
	{
